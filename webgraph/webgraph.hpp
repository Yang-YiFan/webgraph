...
class graph : public base_graph<webgraph::bv_graph::node_iterator> //: ImmutableGraph
{
   ////////////// PRIVATE MEMBERS
private:
...
protected:
   ...
   std::shared_ptr< std::vector<byte> > graph_memory_ptr;
...
public:
//   static void store( std::shared_ptr<graph> graph, std::string
