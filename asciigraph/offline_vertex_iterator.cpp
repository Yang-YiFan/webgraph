...
string offline_vertex_iterator::as_str() const {
   // this will yield linking error of undefined reference as_str[abi:cxx11]
...
int offline_vertex_iterator::outdegree() {
   return current_descriptor.get_successors().size();
}
